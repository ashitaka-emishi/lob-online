...
### Task 1.1 — Gate automatic 1-SP loss on ≥4 attacker SPs (#579)
...
### Task 1.2 — Move leader loss check to SP-loss outcome (#581)
...
### Task 1.3 — Add tests for both fixes
...
### Task 2.1 — Implement §6.4 automatic recovery (pre-roll step)
...
### Task 2.2 — Implement §6.3 per-unit rally rolls
...
### Task 2.3 — Wire rally handler into phase.js
...
## Phase 3 — Fluke Stoppage handler (#382)

### Task 3.1 — Implement FLUKE_STOPPAGE handler in phase.js
...
### Task 3.2 — Add tests for Fluke Stoppage
...
## Phase 4 — Attack Recovery handler (#381)

### Task 4.1 — Implement ATTACK_RECOVERY handler in phase.js
...
### Task 4.2 — Add tests for Attack Recovery
