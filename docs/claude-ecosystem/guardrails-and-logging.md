...
Derived from `docs/workflows/sdlc-feature/sdlc-feature.workflow.json`:

| Gate ID             | Prompt summary                       | Choices         | Default |
| ------------------- | ------------------------------------ | --------------- | ------- |
| `gate-spec`         | Review spec draft; approve or revise | approve, revise | approve |
| `gate-code-review`  | Review findings; accept or fix       | accept, fix     | accept  |
| `gate-test-results` | Review test output; pass or fix      | pass, fix       | pass    |
| `gate-deploy`       | Final merge approval; merge or hold  | merge, hold     | merge   |
