...
_Last updated: 2026-06-04 after PR #491._
...
| Highest-risk item                | refactor(mapEditor): move serverStripNonPlayableBoundaryEdges to engine/ layer (#492, score 3) |
| PRs tracked                      | 232                                                                                            |
...
PR #491 (M5 debt cleanup sprint) closed all eight score-2 actionable items from M5 (#482 #481 #487 #486 #467 #468 #470 #440), reducing the net open score from 32 to 19 — a −13 improvement. One new score-3 item was introduced (#492: layering violation in the map editor server route). The remaining 11 open items comprise: one score-3 architectural coupling item (#492, engine/route layering), five score-2 deferred stubs and infrastructure items (#403 CSP, #383 #382 #381 #379 rules-engine stubs safe until M6 combat, #350 rate-limiting deferred to M8), and four score-1 low-priority items. Current debt is concentrated in rules-engine stubs waiting for M6 combat phases and security/infrastructure work deferred to M8; no item is blocking M6.
