...
_Last updated: 2026-05-23 after PR #448._
...
PR #448 closed 9 score-1/2 items from the PR #437 team review (#436, #438, #439, #442, #443, #444, #445, #446, #447 — 14 points), reducing the net open score from 46 to 32. The two score-3 items remain: #431 (OOB fetched via dev-tool endpoint) — a production-blocker where unit counters silently disappear without `MAP_EDITOR_ENABLED` — and #434 (SVG button AT reliability). Current debt is concentrated in two categories: (1) the production-blocking OOB data path (#431) that must be resolved before any production deployment of game view; and (2) eleven score-2 items covering minor behavioral concerns (#440 sequential fetch latency, #441 stale gridSpec race), accessibility gaps (#432 aria-label, #435 overflow:hidden), rules-engine stubs (#379, #381, #382, #383 — will close at M6), and security/infra items (#350 rate limiting, #403 CSP) deferred to M8 auth hardening.
