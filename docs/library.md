...
| SM_MAP_DATA | `data/modules/south-mountain/map.json`     | 🔧     | Terrain digitization complete — all 841 hexes typed, 0 `unknown` (M9, #669). Hexside features (roads, streams, stone walls, fords/bridges) still pending; tracked in #685.                                                                        |
