...
| SM_MAP_DATA | `data/modules/south-mountain/map.json`     | 🔧     | 2261 hexes, 0 `unknown`, full playable grid coverage (map-data-recovery_20260811, #689). All 10/10 VP hexes reachable, 97.9% elevation completeness. Hexside features substantially present (777/2261 hexes) but not yet visually audited against sm-map.jpg; tracked in #685. |
