...
| SM_MAP_DATA | `data/modules/south-mountain/map.json`     | 🔧     | Hex scaffold with 31 known hexes (VP hexes, setup hexes, entry hexes). Full terrain digitization from sm-map.jpg required to reach `available`.                                                                                                   |
