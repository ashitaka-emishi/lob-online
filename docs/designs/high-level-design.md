...
| Risk                                                                                                                                                                                                                                                                        | Severity                   | Mitigation                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Map digitisation** — Converting `sm-map.jpg` to `map.json` (every hex with coordinates, terrain type, elevation, road/trail flags) is manual work across a 63x35 (2205-cell) grid.                                                                                        | ~~High~~ **Reduced — Low** | Map editor dev tool built (`MapEditorView` + `HexMapOverlay` + `CalibrationControls` + `HexEditPanel`). M9 (#669) typed all then-recorded hexes; map-data-recovery_20260811 (#689) recovered a forgotten git stash and merged its 2261-hex dataset plus a boundary-hex schema fix — all 10/10 VP hexes now reachable, verified via `hexNeighbors()` BFS against the live engine, not just re-asserted. map-col64-investigation_20260812 (#691) resolved the map's apparent 64th column as an unplayable partial-sliver edge hex (real terrain for only ~21% of the hex, confirmed by pixel-level inspection), corrected `gridSpec.cols` to 63; 100% in-grid coverage. Not fully resolved: the row/trail-flags portion of this risk's own scope — hexside-network (road/stream/wall) visual audit still open (#685). |
