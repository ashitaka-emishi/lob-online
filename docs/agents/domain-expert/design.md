...
| ID                | File                                  | Contents                                                                                                                                                                                                                       |
| ----------------- | ------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| SM_MAP_DATA       | `map.json`                            | Hex terrain, gridSpec calibration, VP/entry hexes, type registries (hexsideTypes, hexFeatureTypes, edgeFeatureTypes) — terrain complete (841/841 hexes); hexside features (roads/streams/walls/fords) pending, tracked in #685 |
