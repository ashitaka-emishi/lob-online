...
| ID                | File                                  | Contents                                                                                                                                                                                                                                                                                                                                |
| ----------------- | ------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| SM_MAP_DATA       | `map.json`                            | Hex terrain, gridSpec calibration, VP/entry hexes, type registries (terrainTypes, hexFeatureTypes, edgeFeatureTypes) — 2261 hexes, 2205/2240 in-grid coverage (column 64 open question, #691), all VP hexes reachable (#689); hexside features (roads/streams/walls/fords) substantially present, pending visual audit, tracked in #685 |
