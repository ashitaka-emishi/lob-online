...
| ID                | File                                  | Contents                                                                                                                                                                                                                                                                                                                                          |
| ----------------- | ------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| SM_MAP_DATA       | `map.json`                            | Hex terrain, gridSpec calibration, VP/entry hexes, type registries (terrainTypes, hexFeatureTypes, edgeFeatureTypes) — 841 recorded hexes typed, but real coverage is only ~37% of the 2240-cell grid and 6/10 VP hexes are unreachable; recoverable fuller dataset tracked in #689; hexside features (roads/streams/walls/fords) tracked in #685 |
